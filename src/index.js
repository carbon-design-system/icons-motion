...
export {  ArrowShiftDownMotion, ArrowsHorizontalMotion, ArrowsVerticalMotion, BookmarkMotion, BookmarkAddMotion, BookmarkFilledMotion, CaretSortMotion, CollapseAllMotion, ExploreMotion, FlagMotion, FlagFilledMotion } from './components/Operations'
