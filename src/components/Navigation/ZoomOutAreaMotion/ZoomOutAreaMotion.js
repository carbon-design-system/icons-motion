  ...
  return (
    <div ref={iconRef} className={`${shouldAnimate}`}>
      <svg
        ...
        viewBox='0 0 32 32'
      >
        <g className={styles.ZoomOutAreaBorder}>
        ...
        <g className={styles.ZoomOutAreaGlass}>
          <path d="M16,19h8v2h-8V19z M31,29.6l-4.7-4.7c2.7-3.5,2.1-8.5-1.4-11.3s-8.5-2.1-11.3,1.4s-2.1,8.5,1.4,11.3c2.9,2.3,7,2.3,9.9,0
