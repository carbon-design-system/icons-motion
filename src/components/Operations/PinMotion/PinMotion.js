...
import styles from './pin--motion.module.scss'

const PinMotion = (props) => {
  ...
  return (
    <div ref={iconRef} className={`${shouldAnimate}`}>
      ...
      >
		...
		l-1.7-1.7l9.7-11.5L29.6,12.3z M17.3,21.2l-6.5-6.5L22.3,5L27,9.7L17.3,21.2z"
        />
      </svg>
    </div>
  )
