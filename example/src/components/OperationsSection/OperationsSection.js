...
const OperationsSection = () => {
  ...
  const [arrowsHorizontalAnimating, setArrowsHorizontalAnimating] =
    useState(false)
    ...
    <section className='icon-section'>
      <div className='bx--grid'>
        ...
        <ul className='bx--row icon-tiles-grid'>
          ...
          >
            <h3>Bookmark</h3>
            <icons.BookmarkMotion isAnimating={bookmarkAnimating} size={32} />
          </li>
          <li
            className='icon-tile'
          ...
          >
            <h3>Caret sort</h3>
            <icons.CaretSortMotion isAnimating={caretSortAnimating} size={32} />
          </li>
          <li
            className='icon-tile'
          ...
          >
            <h3>Chat</h3>
            <icons.ChatMotion isAnimating={chatAnimating} size={32} />
          </li>
          <li
            className='icon-tile'
          ...
          >
            <h3>Chat off</h3>
            <icons.ChatOffMotion isAnimating={chatOffAnimating} size={32} />
          </li>
          <li
            className='icon-tile'
          ...
          >
            <h3>Clean</h3>
            <icons.CleanMotion isAnimating={cleanAnimating} size={32} />
          </li>
          <li
            className='icon-tile'
          ...
          >
            <h3>Connect</h3>
            <icons.ConnectMotion isAnimating={connectAnimating} size={32} />
          </li>
          <li
            className='icon-tile'
          ...
          >
            <h3>Explore</h3>
            <icons.ExploreMotion isAnimating={exploreAnimating} size={32} />
          </li>
          <li
            className='icon-tile'
          ...
          >
            <h3>Exit</h3>
            <icons.ExitMotion isAnimating={exitAnimating} size={32} />
          </li>
          <li
            className='icon-tile'
          ...
          >
            <h3>Filter</h3>
            <icons.FilterMotion isAnimating={filterAnimating} size={32} />
          </li>
          <li
            className='icon-tile'
          ...
          >
            <h3>Flag</h3>
            <icons.FlagMotion isAnimating={flagAnimating} size={32} />
          </li>
          <li
            className='icon-tile'
          ...
          >
            <h3>Jump Link</h3>
            <icons.JumpLinkMotion isAnimating={jumpLinkAnimating} size={32} />
          </li>
          <li
            className='icon-tile'
          ...
          >
            <h3>Launch</h3>
            <icons.LaunchMotion isAnimating={launchAnimating} size={32} />
          </li>
          <li
            className='icon-tile'
          ...
          >
            <h3>Layers</h3>
            <icons.LayersMotion isAnimating={layersAnimating} size={32} />
          </li>
          <li
            className='icon-tile'
          ...
          >
            <h3>Log in</h3>
            <icons.LoginMotion isAnimating={loginAnimating} size={32} />
          </li>
          <li
            className='icon-tile'
          ...
          >
            <h3>Logout</h3>
            <icons.LogoutMotion isAnimating={logoutAnimating} size={32} />
          </li>
          <li
            className='icon-tile'
          ...
          >
            <h3>Loop</h3>
            <icons.LoopMotion isAnimating={loopAnimating} size={32} />
          </li>
          <li
            className='icon-tile'
          ...
          >
            <h3>Maximize</h3>
            <icons.MaximizeMotion isAnimating={maximizeAnimating} size={32} />
          </li>
          <li
            className='icon-tile'
          ...
          >
            <h3>Minimize</h3>
            <icons.MinimizeMotion isAnimating={minimizeAnimating} size={32} />
          </li>
          <li
            className='icon-tile'
          ...
          >
            <h3>Move</h3>
            <icons.MoveMotion isAnimating={moveAnimating} size={32} />
          </li>
          <li
            className='icon-tile'
          ...
          >
            <h3>New tab</h3>
            <icons.NewTabMotion isAnimating={newTabAnimating} size={32} />
          </li>
          <li
            className='icon-tile'
          ...
          >
            <h3>Not sent</h3>
            <icons.NotSentMotion isAnimating={notSentAnimating} size={32} />
          </li>
          <li
            className='icon-tile'
          ...
          >
            <h3>Pin</h3>
            <icons.PinMotion isAnimating={pinAnimating} size={32} />
          </li>
          <li
            className='icon-tile'
          ...
          >
            <h3>Pin filled</h3>
            <icons.PinFilledMotion isAnimating={pinFilledAnimating} size={32} />
          </li>
          <li
            className='icon-tile'
          ...
          >
            <h3>Recommend</h3>
            <icons.RecommendMotion isAnimating={recommendAnimating} size={32} />
          </li>
          <li
            className='icon-tile'
          ...
          >
            <h3>Redo</h3>
            <icons.RedoMotion isAnimating={redoAnimating} size={32} />
          </li>
          <li
            className='icon-tile'
          ...
          >
            <h3>Renew</h3>
            <icons.RenewMotion isAnimating={renewAnimating} size={32} />
          </li>
          <li
            className='icon-tile'
          ...
          >
            <h3>Repeat</h3>
            <icons.RepeatMotion isAnimating={repeatAnimating} size={32} />
          </li>
          <li
            className='icon-tile'
          ...
          >
            <h3>Reply</h3>
            <icons.ReplyMotion isAnimating={replyAnimating} size={32} />
          </li>
          <li
            className='icon-tile'
          ...
          >
            <h3>Reply all</h3>
            <icons.ReplyAllMotion isAnimating={replyAllAnimating} size={32} />
          </li>
          <li
            className='icon-tile'
          ...
          >
            <h3>Reset</h3>
            <icons.ResetMotion isAnimating={resetAnimating} size={32} />
          </li>
          <li
            className='icon-tile'
          ...
          >
            <h3>Reset alt</h3>
            <icons.ResetAltMotion isAnimating={resetAltAnimating} size={32} />
          </li>
          <li
            className='icon-tile'
          ...
          >
            <h3>Restart</h3>
            <icons.RestartMotion isAnimating={restartAnimating} size={32} />
          </li>
          <li
            className='icon-tile'
          ...
          >
            <h3>Rotate</h3>
            <icons.RotateMotion isAnimating={rotateAnimating} size={32} />
          </li>
          <li
            className='icon-tile'
          ...
          >
            <h3>Scan</h3>
            <icons.ScanMotion isAnimating={scanAnimating} size={32} />
          </li>
          <li
            className='icon-tile'
          ...
          >
            <h3>Scan alt</h3>
            <icons.ScanAltMotion isAnimating={scanAltAnimating} size={32} />
          </li>
          <li
            className='icon-tile'
          ...
          >
            <h3>Search</h3>
            <icons.SearchMotion isAnimating={searchAnimating} size={32} />
          </li>
          <li
            className='icon-tile'
          ...
          >
            <h3>Send</h3>
            <icons.SendMotion isAnimating={sendAnimating} size={32} />
          </li>
          <li
            className='icon-tile'
          ...
          >
            <h3>Send alt</h3>
            <icons.SendAltMotion isAnimating={sendAltAnimating} size={32} />
          </li>
          <li
            className='icon-tile'
          ...
          >
            <h3>Tag</h3>
            <icons.TagMotion isAnimating={tagAnimating} size={32} />
          </li>
          <li
            className='icon-tile'
          ...
          >
            <h3>Tag edit</h3>
            <icons.TagEditMotion isAnimating={tagEditAnimating} size={32} />
          </li>
          <li
            className='icon-tile'
          ...
          >
            <h3>Tag export</h3>
            <icons.TagExportMotion isAnimating={tagExportAnimating} size={32} />
          </li>
          <li
            className='icon-tile'
          ...
          >
            <h3>Tag group</h3>
            <icons.TagGroupMotion isAnimating={tagGroupAnimating} size={32} />
          </li>
          <li
            className='icon-tile'
          ...
          >
            <h3>Tag import</h3>
            <icons.TagImportMotion isAnimating={tagImportAnimating} size={32} />
          </li>
          <li
            className='icon-tile'
          ...
          >
            <h3>Tag none</h3>
            <icons.TagNoneMotion isAnimating={tagNoneAnimating} size={32} />
          </li>
          <li
            className='icon-tile'
          ...
          >
            <h3>Translate</h3>
            <icons.TranslateMotion isAnimating={translateAnimating} size={32} />
          </li>
          <li
            className='icon-tile'
          ...
          >
            <h3>Undo</h3>
            <icons.UndoMotion isAnimating={undoAnimating} size={32} />
          </li>
          <li
            className='icon-tile'
          ...
          >
            <h3>Upgrade</h3>
            <icons.UpgradeMotion isAnimating={upgradeAnimating} size={32} />
          </li>
          <li
            className='icon-tile'
          ...
          >
            <h3>X axis</h3>
            <icons.XAxisMotion isAnimating={xAxisAnimating} size={32} />
          </li>
          <li
            className='icon-tile'
          ...
          >
            <h3>Y axis</h3>
            <icons.YAxisMotion isAnimating={yAxisAnimating} size={32} />
          </li>
          <li
            className='icon-tile'
          ...
          >
            <h3>Z axis</h3>
            <icons.ZAxisMotion isAnimating={zAxisAnimating} size={32} />
          </li>
          <li
            className='icon-tile'
          ...
          >
            <h3>Idea</h3>
            <icons.IdeaMotion isAnimating={ideaAnimating} needsTitle={ true }   size={32} />
          </li>
        </ul>
      </div>
    </section>
